            ...
            <div className=' lg:px-4 lg:space-x-5 lg:mt-12 flex lg:flex-row flex-col-reverse dark:text-white lg:text-left '>
                ...
                <div className='flex flex-col justify-center'>
                    ...
                    <div className='mt-10 flex w-auto justify-center mb-10 lg:justify-start' >
                        ...
                        <Link to={'https://drive.google.com/file/d/1NuqrAcH9noaDWXTLmeasFcKYAi53Lw_K/view?usp=sharing'} className=" ml-2 py-2 px-4 bg-gray-400 rounded-md text-2xl" target="_blank"><BsFillFileEarmarkPdfFill /></Link>
                    </div>
                </div>
            </div>
        </div>
